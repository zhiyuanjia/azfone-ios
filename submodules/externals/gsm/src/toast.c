...
/* $Header: /home/repository/azfone-ios/submodules/externals/gsm/src/toast.c,v 1.1.1.1 2014/11/13 04:07:24 khc Exp $ */
...
static void version P0()
{
	printf( "%s 1.0, version %s\n",
		progname,
		"$Id: toast.c,v 1.1.1.1 2014/11/13 04:07:24 khc Exp $" );
}

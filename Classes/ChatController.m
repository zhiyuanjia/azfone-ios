...
#define kLocationViewTag 108

#define kPhoneViewTag 109

#define kWebViewTag 110
...

{
    ...
    UIAlertView *errorAlert = [[UIAlertView alloc]
                               ...
                               message:NSLocalizedString(@"The location services seems to be disabled from the settings",nil)
...

{
    ...
    [geocoder reverseGeocodeLocation:[locations lastObject] completionHandler:^(NSArray *placemarks, NSError *error) {
        ...
        [body setXmlns:@"http://jabber.org/protocol/geoloc"];
        [body setStringValue:addressString];
        ...
        if([hostname isEqualToString:_displayname.text]){
            ...
            messageEntity.content = addressString;
...
-(void)webButtonClick:(id)sender{
    ...
    NSString *web =btn.titleLabel.text;
    NSRange tRange = [web rangeOfString:@"http"];
    if (tRange.location == NSNotFound){
        NSString *urlString = [NSString stringWithFormat: @"http://%@", web];
...
-(void)phoneButtonClick:(id)sender{
    
    UIButton *btn = (UIButton *)sender;
    
    NSString *tel =btn.titleLabel.text;
...
-(void)mapButtonClick:(id)sender{
    ...
    NSString *addr =btn.titleLabel.text;
    
    addr = [addr stringByAddingPercentEscapesUsingEncoding: NSUTF8StringEncoding];
    
    NSString* urlStr = [NSString stringWithFormat:@"http://maps.apple.com/maps?daddr=%@", addr];
...
-(void)emailButtonClick:(id)sender{
    ...
    NSString *email = _displayname.text;
        ...
        if ([messageObject isKindOfClass:[MessageEntity class]]) {
            ...
            if ([messageEntity.sender.name isEqualToString:selfUserName]) {
                ...
                if (rightCell==nil) {
                    ...
                    //right cell location button
                    
                    UIButton *locbutton = [UIButton buttonWithType:UIButtonTypeCustom];
                    
                    locbutton.tag =kLocationViewTag;
                    
                    UIImage *btn3Image = [UIImage imageNamed:@"location.png"];
                    
                    
                    
                    [locbutton setImage:btn3Image forState:UIControlStateNormal];
                    
                    
                    
                    [rightCell.contentView addSubview:locbutton];
                    
                    //right cell phone button
                    
                    UIButton *phonebutton = [UIButton buttonWithType:UIButtonTypeCustom];
                    
                    phonebutton.tag =kPhoneViewTag;
                    
                    UIImage *btn4Image = [UIImage imageNamed:@"phone.png"];
                    
                    
                    
                    [phonebutton setImage:btn4Image forState:UIControlStateNormal];
                    
                    
                    
                    [rightCell.contentView addSubview:phonebutton];
                    
                    //right cell web button
                    
                    UIButton *webbutton = [UIButton buttonWithType:UIButtonTypeCustom];
                    
                    webbutton.tag =kWebViewTag;
                    
                    UIImage *btn5Image = [UIImage imageNamed:@"web.png"];
                    
                    
                    
                    [webbutton setImage:btn5Image forState:UIControlStateNormal];
                    
                    
                    
                    [rightCell.contentView addSubview:webbutton];
                    ...
                    
                {
                    ...
                    UIButton *webbutton = (UIButton*)[rightCell.contentView viewWithTag:kWebViewTag];
                    
                    CGRect webframe =CGRectMake(267-contentSize.size.width, contentSize.size.height-18, 30 , 30);
                    
                    webbutton.frame =webframe;
                    
                    webbutton.titleLabel.text =contentLabel.text;
                    
                    webbutton.titleLabel.hidden =YES;
                    
                    [webbutton addTarget:self
                     
                                    action:@selector(webButtonClick:)
                     
                          forControlEvents:UIControlEventTouchUpInside];
                    
                    NSString*web =contentLabel.text;
                    
                    
                    
                    NSDataDetector *detect2 = [[NSDataDetector alloc] initWithTypes:NSTextCheckingTypeLink error:nil];
                    
                    
                    [webbutton setHidden:YES];
                    
                    [detect2 enumerateMatchesInString:web options:kNilOptions range:NSMakeRange(0, [web length]) usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                        
                        [webbutton setHidden:NO];
                    }];

                    
                    //phone button
                    
                    UIButton *phonebutton = (UIButton*)[rightCell.contentView viewWithTag:kPhoneViewTag];
                    
                    CGRect phoneframe =CGRectMake(267-contentSize.size.width, contentSize.size.height-16, 20, 20);
                    
                    phonebutton.frame =phoneframe;
                    
                    phonebutton.titleLabel.text =contentLabel.text;
                    
                    phonebutton.titleLabel.hidden =YES;
                    ...
                    NSString*phone =contentLabel.text;
                    ...
                    [detect1 enumerateMatchesInString:phone options:kNilOptions range:NSMakeRange(0, [phone length]) usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                    ...
                    UIButton *locbutton =(UIButton*)[rightCell.contentView viewWithTag:kLocationViewTag];
                    
                    CGRect buttonframe =CGRectMake(267-contentSize.size.width, contentSize.size.height-25, 30, 30);
                    
                    locbutton.frame =buttonframe;
                    
                    locbutton.titleLabel.text =contentLabel.text;
                    
                    locbutton.titleLabel.hidden =YES;
                    
                    [locbutton addTarget:self
                     
                                  action:@selector(mapButtonClick:)
                     
                        forControlEvents:UIControlEventTouchUpInside];
                    
                    NSString*location =contentLabel.text;
                    
                    
                    
                    NSDataDetector *detect = [[NSDataDetector alloc] initWithTypes:NSTextCheckingTypeAddress error:nil];
                    
                    
                    [locbutton setHidden:YES];
                    
                    [detect enumerateMatchesInString:location options:kNilOptions range:NSMakeRange(0, [location length]) usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                        [locbutton setHidden:NO];
                    }];
                    ...
                    CGRect webframe =CGRectMake(717-contentSize.size.width, contentSize.size.height-18, 30, 30);
                    ...
                    CGRect phoneframe =CGRectMake(717-contentSize.size.width, contentSize.size.height-16, 20, 20);
                    ...
                    CGRect buttonframe =CGRectMake(717-contentSize.size.width, contentSize.size.height-25, 30, 30);
                ...
                if (leftCell==nil) {
                    ...
                    [leftCell.contentView addSubview:locbutton];
                    
                    
                    //left cell phone button
                    ...
                    [leftCell.contentView addSubview:phonebutton];

                    //left cell web button
                    ...
                    [leftCell.contentView addSubview:webbutton];
                ...
                UIButton *webbutton = (UIButton*)[leftCell.contentView viewWithTag:kWebViewTag];
                
                CGRect webframe =CGRectMake(contentSize.size.width+70, 6, 30, 30);
                ...
                UIButton *phonebutton = (UIButton*)[leftCell.contentView viewWithTag:kPhoneViewTag];
                
                CGRect phoneframe =CGRectMake(contentSize.size.width+70, 8, 20, 20);
                ...
                UIButton *locbutton =(UIButton*)[leftCell.contentView viewWithTag:kLocationViewTag];
                
                CGRect buttonframe =CGRectMake(contentSize.size.width+60, 17, 30, 30);

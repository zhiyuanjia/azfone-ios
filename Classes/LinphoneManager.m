...
+ (NSSet *)unsupportedCodecs {
	...
	for(int i=0;codec_pref_table[i].name!=NULL;++i) {
        ...
        if([g729 isEqualToString:@"to_be_installed"] &&[h264 isEqualToString:@"to_be_installed"]){
        if( (available == NULL)
        ...
        else if([g729 isEqualToString:@"to_be_installed"] && [h264 isEqualToString:@"no_installation"]){
            if( (available == NULL)
               // these two codecs should not be hidden, even if not supported
        ...
        else if([h264 isEqualToString:@"to_be_installed"]&&[g729 isEqualToString:@"no_installation"]){
            if( (available == NULL)
               // these two codecs should not be hidden, even if not supported

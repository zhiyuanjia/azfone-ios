...
- (void)viewDidLoad {
    [super viewDidLoad];
	[linkLabel setText:NSLocalizedString(@"http://www.azblink.com/", nil)];
    
	[licenseLabel setText:NSLocalizedString(@"GNU General Public License V2 ", nil)];
	[copyrightLabel setText:NSLocalizedString(@"© 2014- Azblink Technology ", nil)];
	
    [linkLabel addGestureRecognizer:linkTapGestureRecognizer];
    [_linkLabel3 addGestureRecognizer:linkTapGestureRecognizer];
    ...
    [linphoneIphoneVersionLabel setText:[NSString stringWithFormat:@"AzFone iPhone 3.0.1"]];
